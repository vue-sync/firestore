import { isFullString, isNumber, isArray } from 'is-what';
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        documentPath = getFirestoreDocPath(collectionPath, docId, pluginModuleConfig, firestorePluginOptions) // prettier-ignore
                        ;
                        payloadArray = isArray(payload) ? payload : [payload];
                        firestorePayload = payloadArray.reduce(function (carry, propPath) {
                            var _a;
                            return (__assign(__assign({}, carry), (_a = {}, _a[propPath] = firestore.FieldValue["delete"](), _a)));
                        }, {});
